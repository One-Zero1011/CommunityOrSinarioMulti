...
import { MousePointer2, Image as ImageIcon, Upload, Flag } from 'lucide-react';
...
export const EditorToolbar: React.FC<EditorToolbarProps> = ({ mapName, onAddObject, onBackgroundUpload }) => {
  ...
  return (
    <div className="h-12 bg-[#252525] border-b border-[#444] flex items-center px-4 space-x-4 text-gray-200">
      ...
      <button onClick={() => onAddObject('SPAWN_POINT')} className="flex items-center gap-1 text-sm bg-violet-800 hover:bg-violet-700 px-3 py-1 rounded text-white shadow-sm">
         <Flag size={14} /> 시작 위치
      </button>
